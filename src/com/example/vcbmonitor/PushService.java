...
public class PushService extends Service {
	...
	public static void actionStart(Context ctx) {
		System.out.println("start push service");
	...
	public void onCreate() {
		...
		/*
		 * try { //mLog = new ConnectionLog(); //Log.i(TAG, "Opened log at " +
		 * mLog.getPath()); } catch (IOException e) { Log.e(TAG,
	...
	public void onDestroy() {
		...
		/*
		 * try { if (mLog != null) mLog.close(); } catch (IOException e) {}
		 */
	}
	...
	private void log(String message, Throwable e) {
		...
		/*
		 * if (mLog != null) { try { mLog.println(message); } catch (IOException
		 * ex) {} }
		 */
	}
	...
	private class MQTTConnection implements MqttSimpleCallback {
		...
		public MQTTConnection(String brokerHostName, String initTopic) {
			...
			try {
				...
				// ID
				// and device ID.
				initTopic = MQTT_CLIENT_ID + "/" + "tt"; 

				subscribeToTopic(initTopic);
				log("After topic: " + initTopic);
